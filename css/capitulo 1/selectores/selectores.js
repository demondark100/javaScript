...
const mensaje_enojado = document.querySelector(".mensaje_enojado");
const mensaje_content = document.querySelector(".mensaje_content");
mensaje_enojado.addEventListener("click",()=>{
    mensaje_content.classList.add("modificar");
    setTimeout(() => {
        mensaje_content.classList.remove("modificar");
    }, 4000);
})