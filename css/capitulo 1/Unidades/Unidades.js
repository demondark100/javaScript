...
const b_rem = document.querySelector(".b_rem");
const content_rem = document.querySelector(".content_rem");
b_rem.addEventListener("click",()=>{
    content_rem.classList.add("mostrar_content_rem");
    setTimeout(() => {
        content_rem.classList.remove("mostrar_content_rem");
    }, 5000);
})